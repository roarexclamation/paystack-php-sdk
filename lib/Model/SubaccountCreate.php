...
/**
 * SubaccountCreate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SubaccountCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubaccountCreate';
    ...
    */
     ...
     *
     * @param string $settlement_bank Bank code for the bank. You can get the list of Bank Codes by calling the List Banks endpoint.
     *
     * @return self
     */
     ...
     *
     * @param float $percentage_charge Customer's phone number
     *
     * @return self
     */
