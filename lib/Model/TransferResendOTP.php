 ...
 */
class TransferResendOTP implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransferResendOTP';
    ...
    */
     ...
     * Sets transfer_code
     *
     * @param string $transfer_code The transfer code that requires an OTP validation
     *
     * @return self
     */
