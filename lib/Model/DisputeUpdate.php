...
class DisputeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DisputeUpdate';
    ...
    */
     ...
     *
     * @param string|null $uploaded_filename Filename of attachment returned via response from the Dispute upload URL
     *
     * @return self
     */
