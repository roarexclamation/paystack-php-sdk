...
/**
 * ProductListsResponseArray Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProductListsResponseArray implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductListsResponseArray';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['variant_options'] === null) {
            $invalidProperties[] = "'variant_options' can't be null";
        }
     ...
     *
     * @param int $low_stock_alert low_stock_alert
     *
     * @return self
     */
