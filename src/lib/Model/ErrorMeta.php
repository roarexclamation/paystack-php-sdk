 ...
 */
class ErrorMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ErrorMeta';
    ...
    */
     ...
     * Sets next_step
     *
     * @param string|null $next_step A summarised solution for the error
     *
     * @return self
     */
