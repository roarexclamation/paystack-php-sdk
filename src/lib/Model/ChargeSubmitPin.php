 ...
 */
class ChargeSubmitPin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChargeSubmitPin';
    ...
    */
     ...
     * Sets reference
     *
     * @param string $reference Transaction reference that requires the PIN
     *
     * @return self
     */
