 ...
 */
class PaymentRequestUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentRequestUpdate';
    ...
    */
     ...
     * Sets customer
     *
     * @param string|null $customer Customer id or code
     *
     * @return self
     */
