...
class PlanUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Name of plan
     *
     * @return self
     */
     ...
     * Sets interval
     *
     * @param string|null $interval Interval in words. Valid intervals are daily, weekly, monthly,biannually, annually
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param bool|null $description A description for this plan
     *
     * @return self
     */
