...
class DisputeResolve implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'uploaded_filename' => 'setUploadedFilename',
    ...
    protected static $getters = [
        ...
        'uploaded_filename' => 'getUploadedFilename',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('uploaded_filename', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['uploaded_filename'] === null) {
            $invalidProperties[] = "'uploaded_filename' can't be null";
        }
    ...
    /**
     * Gets uploaded_filename
     *
     * @return string
     */
    public function getUploadedFilename()
    {
        return $this->container['uploaded_filename'];
    }

    /**
     * Sets uploaded_filename
     *
     * @param string $uploaded_filename Filename of attachment returned via response from the Dispute upload URL
     *
     * @return self
     */
    public function setUploadedFilename($uploaded_filename)
    {
        if (is_null($uploaded_filename)) {
            throw new \InvalidArgumentException('non-nullable uploaded_filename cannot be null');
        }
        $this->container['uploaded_filename'] = $uploaded_filename;
