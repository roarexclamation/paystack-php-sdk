 ...
 */
class OrderFetchResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderFetchResponse_data';
    ...
    protected static $openAPITypes = [
        ...
        'transaction' => 'int',
        'is_gift' => 'bool',
        'payer' => '\OpenAPI\Client\Model\TransactionFetchResponseDataCustomer',
        'fully_refunded' => 'bool',
        'refunded_amount' => 'int',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_gift'] === null) {
            $invalidProperties[] = "'is_gift' can't be null";
        }
     ...
     * Sets payer
     *
     * @param \OpenAPI\Client\Model\TransactionFetchResponseDataCustomer $payer payer
     *
     * @return self
     */
