 ...
 */
class TransactionListResponseArraySource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionListResponseArray_source';
