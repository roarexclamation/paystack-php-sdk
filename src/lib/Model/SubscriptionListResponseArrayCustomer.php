...
/**
 * SubscriptionListResponseArrayCustomer Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SubscriptionListResponseArrayCustomer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionListResponseArray_customer';
    ...
    protected static array $openAPINullables = [
        ...
        'metadata' => false,
        'risk_action' => false,
        'international_format_phone' => false
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['international_format_phone'] === null) {
     ...
     *
     * @param string $international_format_phone international_format_phone
     *
     * @return self
     */
    public function setInternationalFormatPhone($international_format_phone)
    {
        if (is_null($international_format_phone)) {
            throw new \InvalidArgumentException('non-nullable international_format_phone cannot be null');
        }
