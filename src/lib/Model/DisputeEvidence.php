...
class DisputeEvidence implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets customer_phone
     *
     * @param string $customer_phone Customer mobile number
     *
     * @return self
     */
     ...
     *
     * @param string $service_details Details of service offered
     *
     * @return self
     */
     ...
     *
     * @param string|null $delivery_address Delivery address
     *
     * @return self
     */
     ...
     * Sets delivery_date
     *
     * @param \DateTime|null $delivery_date ISO 8601 representation of delivery date (YYYY-MM-DD)
     *
     * @return self
     */
