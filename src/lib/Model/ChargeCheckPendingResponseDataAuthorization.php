<?php
/**
 * ChargeCheckPendingResponseDataAuthorization
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ChargeCheckPendingResponseDataAuthorization Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ChargeCheckPendingResponseDataAuthorization implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChargeCheckPendingResponse_data_authorization';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['receiver_bank_account_number'] === null) {
            $invalidProperties[] = "'receiver_bank_account_number' can't be null";
        }
        if ($this->container['receiver_bank'] === null) {
