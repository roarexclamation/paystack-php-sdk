...
/**
 * TransactionFetchResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TransactionFetchResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionFetchResponse_data';
    ...
    protected static $openAPITypes = [
        ...
        'fees' => 'int',
        'fees_split' => 'mixed',
        'authorization' => '\OpenAPI\Client\Model\TransactionFetchResponseDataAuthorization',
        ...
        'source' => '\OpenAPI\Client\Model\TransactionFetchResponseDataSource',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('helpdesk_link', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['helpdesk_link'] === null) {
            $invalidProperties[] = "'helpdesk_link' can't be null";
        }
    ...
    {
        return $this->container['helpdesk_link'];
    }

    /**
     * Sets helpdesk_link
     *
     * @param mixed $helpdesk_link helpdesk_link
     *
     * @return self
     */
    public function setHelpdeskLink($helpdesk_link)
    {
        if (is_null($helpdesk_link)) {
            array_push($this->openAPINullablesSetToNull, 'helpdesk_link');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('helpdesk_link', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['helpdesk_link'] = $helpdesk_link;
     ...
     * Gets authorization
     *
     * @return \OpenAPI\Client\Model\TransactionFetchResponseDataAuthorization
     */
     ...
     * Sets authorization
     *
     * @param \OpenAPI\Client\Model\TransactionFetchResponseDataAuthorization $authorization authorization
     *
     * @return self
     */
     ...
     * Gets source
     *
     * @return \OpenAPI\Client\Model\TransactionFetchResponseDataSource
     */
     ...
     * Sets source
     *
     * @param \OpenAPI\Client\Model\TransactionFetchResponseDataSource $source source
     *
     * @return self
     */
