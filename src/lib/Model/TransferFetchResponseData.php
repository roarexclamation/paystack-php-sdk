...
/**
 * TransferFetchResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TransferFetchResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransferFetchResponse_data';
    ...
    protected static $openAPITypes = [
        ...
        'updated_at' => 'string',
        'recipient' => '\OpenAPI\Client\Model\TransferRecipientCreateResponseData',
        'session' => '\OpenAPI\Client\Model\TransferListResponseArraySession',
        'fee_charged' => 'int',
        'fees_breakdown' => '\OpenAPI\Client\Model\TransferFeesBreakdownArray[]',
    ...
    */
     ...
     * Gets recipient
     *
     * @return \OpenAPI\Client\Model\TransferRecipientCreateResponseData
     */
     ...
     * Sets recipient
     *
     * @param \OpenAPI\Client\Model\TransferRecipientCreateResponseData $recipient recipient
     *
     * @return self
     */
     ...
     * Gets fees_breakdown
     *
     * @return \OpenAPI\Client\Model\TransferFeesBreakdownArray[]
     */
     ...
     * Sets fees_breakdown
     *
     * @param \OpenAPI\Client\Model\TransferFeesBreakdownArray[] $fees_breakdown fees_breakdown
     *
     * @return self
     */
    ...
    public function setGatewayResponse($gateway_response)
    {
        if (is_null($gateway_response)) {
            array_push($this->openAPINullablesSetToNull, 'gateway_response');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('gateway_response', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
